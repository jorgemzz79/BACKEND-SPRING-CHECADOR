...
public class CorsConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.addAllowedOrigin("http://localhost"); // Permite el acceso desde localhost
        configuration.addAllowedOrigin("http://192.168.1.100"); // Permite el acceso desde la IP 192.168.1.100
